...
<body>
    <div id="app">
        <div class="back-view-layout d-flex">

            @if (!Route::is('admin.users.create'))
                <nav class="navbar navbar-expand-md navbar-light bg-white shadow" id="back-navbar">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link disabled " @if (Route::is('admin.services.index'))  @endif
