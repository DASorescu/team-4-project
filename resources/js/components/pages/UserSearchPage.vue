                                ...
                                <div id="my-card" class="card shadow w-100 my-2" v-for="doctor in filteredDoctorsBy"
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <div class="mr-2 col-3">
                                            <input class="img-fluid w-75 border border-white rounded-circle"
                                                type="image" :src="doctor.detail.image" alt="" />
                                        </div>
                                        <div class="col-5 border-left border-white">
                                            ...
                                            <div class="mb-3" v-if="currentSpecialization > 0">
                                                <span v-for="specialization in printSp" :key="specialization.id"
                                                    :class="'badge badge-' + specialization.color">{{ specialization.label }}</span>
                                                <span class="ml-1">
                                                    <font-awesome-icon icon="fa-solid fa-user-doctor" />
                                                </span>
                                            </div>
                                            <p>Città: {{ doctor.detail.address }} <span class="ml-1">
                                                    <font-awesome-icon icon="fa-solid fa-location-dot" />
                                                </span> </p>
                                            <p> Telefono:{{ doctor.detail.phone }} <span class="ml-1">
